...
public class Bootcamp {
	...
	private final LocalDate dateFinal = dateInical.plusDays(45);
	...
	@Override
	public int hashCode() {
		return Objects.hash(conteudos, dateFinal, dateInical, descricao, devsInscritos, nome);
	}
	@Override
	public boolean equals(Object obj) {
		...
		return Objects.equals(conteudos, other.conteudos) && Objects.equals(dateFinal, other.dateFinal)
				&& Objects.equals(dateInical, other.dateInical) && Objects.equals(descricao, other.descricao)
